...
; commands that are used to go to the next set of credits texts.
	db CRED_POKEMON, CRED_MINBATTLESVERSION, CRED_TEXT_FADE_MON
	db CRED_DIRECTOR, CRED_LILY, CRED_TEXT_FADE_MON
	db CRED_SPECIAL_THANKS, CRED_RANGI, CRED_TEXT_FADE_MON
	db CRED_SPECIAL_THANKS, CRED_33DANNYE, CRED_CHATOT4444, CRED_JOJOBEAR13, CRED_TEXT_FADE_MON
	db CRED_SPECIAL_THANKS, CRED_VORTIENE, CRED_AX6, CRED_VULCANDTH, CRED_TEXT_FADE_MON
	db CRED_SPECIAL_THANKS, CRED_CHLOERAWR, CRED_CELESTIALAMBER, CRED_VIMESCARROT, CRED_TEXT_FADE_MON
	db CRED_SPECIAL_THANKS, CRED_IIMARCKUS, CRED_SNARFLAXUS, CRED_SATOMEW, CRED_TEXT_FADE_MON
	db CRED_SPECIAL_THANKS, CRED_MORD, CRED_SEA, CRED_EEVEETASTIC0, CRED_TEXT_FADE_MON
	db CRED_SPECIAL_THANKS, CRED_LJSTAR, CRED_RAINBOWMETALPIGEON, CRED_TEXT_FADE_MON
	db CRED_SPECIAL_THANKS, CRED_PRET, CRED_TEXT_FADE_MON
	db CRED_SPECIAL_THANKS, CRED_GAMEFREAK, CRED_TEXT_FADE_MON
