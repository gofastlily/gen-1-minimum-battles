; CreditsTextPointers indexes (see data/credits/credits_text.asm)
	...
	const CRED_MINBATTLESVERSION
	const CRED_LILY
	const CRED_RANGI
	const CRED_33DANNYE
	const CRED_CHATOT4444
	const CRED_JOJOBEAR13
	const CRED_VORTIENE
	const CRED_AX6
	const CRED_VULCANDTH
	const CRED_CHLOERAWR
	const CRED_CELESTIALAMBER
	const CRED_VIMESCARROT
	const CRED_IIMARCKUS
	const CRED_SNARFLAXUS
	const CRED_SATOMEW
	const CRED_MORD
	const CRED_SEA
	const CRED_EEVEETASTIC0
	const CRED_LJSTAR
