...
# Usage:  tools/free_space.awk [BANK=<bank_spec>] minbattles.map
...
# Yes:  tools/free_space.awk BANK=all minbattles.map
# No:   tools/free_space.awk minbattles.map BANK=42
